...
namespace WpfAppExcelXML
{
    public partial class MainWindow : Window
    {
        ...
        private void CargarDatos()
        {
            ...
            {
                new Votaciones {Nombre = "a", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "b", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "c", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "d", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "e", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "f", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "g", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "h", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "i", numParti = 300,  porcentajeParti = 24.69, voto = "SI" },
                new Votaciones {Nombre = "j", numParti = 300,  porcentajeParti = 24.69, voto = "SI" }
                },
